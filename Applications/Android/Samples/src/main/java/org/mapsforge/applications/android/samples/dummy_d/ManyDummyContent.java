 ...
 */
package org.mapsforge.applications.android.samples.dummy_d;
...
public class ManyDummyContent extends Dummy_Content {

    /**
     * A map of sample (dummy) items, by ID. Retrieved from http://nominatim.openstreetmap.org      d
