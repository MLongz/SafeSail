...
public class SailsafeApplication extends Application {
	...
	public void onCreate() {
		...
		MapWorkerPool.NUMBER_OF_THREADS = Integer.parseInt(preferences.getString(SailsafeApplication.SETTING_RENDERING_THREADS, Integer.toString(MapWorkerPool.DEFAULT_NUMBER_OF_THREADS)));
